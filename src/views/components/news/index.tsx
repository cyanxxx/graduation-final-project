        ...
        return (
            <div>
                <div className="panel-block">
                    <span style={{ flex: '3 1 0' }} className='is-size-7'>活动日期</span>
                    <span style={{ flex: '7 1 0' }} className='is-size-7'>活动名称</span>
                </div>
                {
    ...
    renderActivity() {
        return (
            <div>
                <div className="panel-block">
                    <span style={{ flex: '3 1 0' }} className='is-size-7'>活动日期</span>
                    <span style={{ flex: '5 1 0' }} className='is-size-7'>活动名称</span>
                    <span style={{ flex: '2 1 0' }} className='is-size-7'>地点</span>
                </div>

          ...
          <Login
            login={async (email, pwd) =>
              this.props.location.state && this.props.location.state.from
                ? await this.props.core.user.login(email, pwd, this.props.location.state.from)
                : await this.props.core.user.login(email, pwd)
            }
          ></Login>
        );
      case '/register':
        ...
        return (
          <Register
            register={async (username, pwd) =>
              await this.props.core.user.register({
                username,
                password: pwd,
              })
            }

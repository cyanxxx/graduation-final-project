    ...
    render() {
        ...
        switch (mode) {
            ...
            case displayMode.month:
                ...
                break
            default:
                pannl = <WeekPannel cur_month={cur_month} cur_year={cur_year} today={date} choiceDay={this.selectDate} startDate={this.props.start_day} endDate={this.props.end_day}></WeekPannel>
                break
        }
        return this.props.render && (<div className='date' style={{ width: '100%' }}>

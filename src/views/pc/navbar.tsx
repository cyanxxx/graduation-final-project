    ...
    return (
      <div className="navbar-item">
        ...
        <Modal
          ...
          pannelHandle={this.handleRender}
        >
          {this.state.container == '登录' ? (
            <Login
              login={async (email, pwd) => {
                this.handleRender();
                return await this.props.core.user.login(email, pwd);
              }}
            ></Login>
          ) : (
            <Register
              register={async (username, pwd) => {
                this.handleRender();
                return await this.props.core.user.register({
                  username,
                  password: pwd,
                });
              }}
  ...
  public render = () => {
    return (
      ...
      >
        ...
        >
          <div className="navbar-start">{this.props.spec.map(this.renderLinks)}</div>
